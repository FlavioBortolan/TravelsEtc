...
urlpatterns=[
    ...
    path('buyticket/<int:pk>/<str:buy_step>/<str:cmd>/<int:total>/<int:credits_to_use>/<int:order_id>/<str:friend_id>',views.BuyTicketView.as_view(),name="buyticket"),
    ...
    path('card_pay/<int:amount>/<int:order_id>/<str:friend_id>',views.CardPayView.as_view(),name="card_pay"),
